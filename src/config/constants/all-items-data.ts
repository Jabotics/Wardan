...
export const ALL_ITEMS_DATA = [
  createItem(
    '/images/products/both-sides/jeera-front.png',
    '/images/products/both-sides/jeera-back.png',
    "Jeera",
  ...
  createItem(
    '/images/products/both-sides/dhaniya-front.png',
    '/images/products/both-sides/dhaniya-back.png',
    "Dhaniya",
    "Manufactured & Packaged by Wardan Spices Private Limited.",
  ...
  createItem(
    '/images/products/both-sides/lal-mirch-front.png',
    '/images/products/both-sides/lal-mirch-back.png',
    "Lal Mirch",
    "Manufactured & Packaged by Wardan Spices Private Limited.",
  ...
  createItem(
    '/images/products/both-sides/haldi-front.png',
    '/images/products/both-sides/haldi-back.png',
    "Haldi",
    "Manufactured & Packaged by Wardan Spices Private Limited.",
  ...
  createItem(
    '/images/products/both-sides/garam-masala-front.png',
    '/images/products/both-sides/garam-masala-back.png',
    "Garam Masala",
    "Manufactured & Packaged by Wardan Spices Private Limited.",
